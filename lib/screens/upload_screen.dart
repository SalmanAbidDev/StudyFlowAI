...
class _UploadScreenState extends State<UploadScreen> {
  ...
  void initState() {
    super.initState();
    _ticker = Timer.periodic(const Duration(milliseconds: 600), (t) {
      if (!mounted) return;
      setState(() {
        _progress += 0.03;
        if (_progress >= 1) _progress = 0.08;
      });
    });
  }
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SfMono('${(_progress * 100).round()}%',
                                      color: sf.ink3),
                                ],
                              ),
                              const SizedBox(height: 4),
                              SfProgress(value: _progress),
                              const SizedBox(height: 4),
                              Text(
                                '4.2MB · 12s left',
