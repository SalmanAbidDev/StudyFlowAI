...
class _MaterialsScreenState extends State<MaterialsScreen> {
  ...
  List<StudyMaterial> get _visible {
    if (_filter == 0) return demoMaterials;
    final tag = demoLibraryFilters[_filter].label;
...
class _EmptyLibrary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Padding(
        padding: const EdgeInsets.fromLTRB(22, 0, 22, kFloatingNavHeight),
        child: SfCard(
