...
class PremiumScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final yearly = ref.watch(yearlyBillingProvider);

    return Scaffold(
      body: ListView(
        // The hero runs edge to edge under the status bar, so this screen opts
        // out of SafeArea and pays the bottom inset back as scroll padding.
                  ...
                  for (final option in [false, true])
                    Expanded(
                      child: GestureDetector(
                        onTap: () =>
                            ref.read(yearlyBillingProvider.notifier).update(option),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          yearly ? 'YEARLY · BEST VALUE' : 'MONTHLY',
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w700,
                            letterSpacing: 0.5,
